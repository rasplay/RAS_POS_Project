...
<?php //이 녀석은 장바구니인 table sell에서 상품 이름을 뽑아서 나열해주는 문이다.
...
?>
        ...
        <td width="40%">
            <p align="center"><span style="font-size:36pt;"><b>
<?php //이 녀석은 장바구니인 table sell에서 상품 가격을 뽑아서 나열해주는 문이다.
    ...
    <tr>
        <td width="1235" height="166" bordercolor="white">
            <form name="form1" method="post" action="result_price_2.php">
                <p align="center">
<!--바코드가이 입력되면 result_price_2.php로 넘겨진다. 이때 이 코드에 어떤 값이 들어가냐에 따라서 흐름이 달라진다. 자세한 것은 result_price_2.php 주석 참조.-->
<input type="text" name="code" maxlength="15" size="5" style="font-family:돋움; font-weight:bolder; font-size:80;"> &nbsp;&nbsp;&nbsp;<input type="submit" name="post" value="바코드입력" style="font-family:돋움; font-weight:bolder; font-size:60; border-width:2;"></p>
            </form>
